...
modelinstance.train(dataset_url="https://firebasestorage.googleapis.com/v0/b/pdf-analysis-saas.appspot.com/o/Other%2Fdataset.json?alt=media&token=28abd658-a308-4050-b631-54bab9b63a6b", model_name="mistral7btest", max_steps=5, max_length=512) # here it is using dummy dataset available on this link.
